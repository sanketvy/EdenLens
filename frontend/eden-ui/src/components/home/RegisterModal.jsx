            ...
            <div className="bg-white text-black p-6 rounded-lg w-[480px] shadow-2xl text-center" onClick={(e) => e.stopPropagation()}>
                <div>
                    ...
                    <div className="flex flex-col">
                        <p className="text-left mt-10 mb-2">Full Name:</p>
                        <input type="text" placeholder="Enter your Full Name" className="w-full bg-gray-100 p-2" />
                        
                        <p className="text-left mt-5 mb-2">Company:</p>
                        <input type="text" placeholder="Enter your Company" className="w-full bg-gray-100 p-2" />

                        <p className="text-left mt-5 mb-2">Email:</p>
